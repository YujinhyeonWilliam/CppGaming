...
void EditScene::Update()
{
	...
	if (inputManager->GetButtonDown(KeyType::LeftMouse))
	{
	...
	if (inputManager->GetButtonDown(KeyType::RightMouse))
		_setOrigin = true;

	// Save
	if (inputManager->GetButtonDown(KeyType::S))
	{
		wofstream file;
	...
	// Load
	if (inputManager->GetButtonDown(KeyType::D))
	{
		wifstream file;
		file.open(L"Unit.txt");
